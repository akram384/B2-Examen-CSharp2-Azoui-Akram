...
namespace MyApp
{
    class Program
    {
        ...
        private static DepartementService _deptServices = new DepartementService(_DemandeALutilisateur);
        private static CommuneService _communeService = new CommuneService(_DemandeALutilisateur, _deptServices);
